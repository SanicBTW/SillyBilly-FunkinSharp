...
using SillyBilly.FunkinSharp.Mod;
...
namespace FunkinSharp.Game.Core
{
    ...
    public static class Paths
    {
        ...
        public static void Initialize(GameHost host, AudioManager audioManager, TextureStore textures, out DllResourceStore[] resources)
        {
            ...
            //dllResources.AddStore(resources[1] = new DllResourceStore(ModResources.ResourceAssembly)); // TODO: in a future version of FunkinSharp, it should look for any .Mod dll in the output folder and load it here hehe
        ...
        public static Stream GetStream(string path)
        {
            ...
            {
                path = $"{ModInfo.ResourcesPrefix}{path}";
                if (!availableResources.Contains(path))
